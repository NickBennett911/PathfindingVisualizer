...
class Tile():
    def __init__(self, x, y, frontier_tile, start_tile, visited_tile, end_tile, block_tile):
    ...
    def draw(self, win):
        if not self.start_tile and not self.frontier and not self.visited and not self.end and not self.barrier and not self.best_path:
